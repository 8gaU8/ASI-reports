...
\begin{figure}[H] %
    \centering
    \subfloat[SubcaptionA]{\includegraphics[width=0.45\textwidth]{images/giraffe.jpg}} \hspace{0.1cm}
...
\hline
\textbf{TitleVeryVeryLong1} & \textbf{Title2} & \textbf{TitleVeryVeryLong3} & \textbf{Title4} & \textbf{TitleVeryVeryLong5} & \textbf{Title6} \\ \hline \hline
1 &2& 3 & 4 & 5  & 6 \\ \hline
1 &2& 3 & 4 & 5  & 6 \\ \hline
...
\begin{algorithm}[H]
    ...
    \IF{$NND[i] < \left\lceil \displaystyle\frac{G.get\_nb\_veins(i)}{2} \right\rceil$}
